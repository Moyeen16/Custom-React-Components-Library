...
.border-table-pagination-border {
  --tw-border-opacity: 1;
  border-color: rgb(178 176 182 / var(--tw-border-opacity));
}
.border-table-pagination-border-disabled {
  --tw-border-opacity: 1;
  border-color: rgb(233 231 233 / var(--tw-border-opacity));
}
.border-tags-border {
  --tw-border-opacity: 1;
...
.border-tags-border-processing {
  --tw-border-opacity: 1;
  border-color: rgb(102 163 255 / var(--tw-border-opacity));
}
.border-tags-border-success {
  --tw-border-opacity: 1;
  border-color: rgb(152 218 151 / var(--tw-border-opacity));
}
.border-tags-border-warning {
  --tw-border-opacity: 1;
  border-color: rgb(238 212 122 / var(--tw-border-opacity));
}
.bg-black {
  --tw-bg-opacity: 1;
...
.bg-table-pagination-bg-disbaled {
  --tw-bg-opacity: 1;
  background-color: rgb(250 250 250 / var(--tw-bg-opacity));
}
.bg-tags-bg {
...
.bg-tags-bg-success {
  --tw-bg-opacity: 1;
  background-color: rgb(204 236 203 / var(--tw-bg-opacity));
}
.bg-tags-bg-warning {
  --tw-bg-opacity: 1;
  background-color: rgb(247 233 189 / var(--tw-bg-opacity));
}
.bg-transparent {
...
.text-table-accent {
  --tw-text-opacity: 1;
  color: rgb(50 162 155 / var(--tw-text-opacity));
}
.text-table-pagination-text {
  --tw-text-opacity: 1;
  color: rgb(69 66 80 / var(--tw-text-opacity));
}
.text-table-pagination-text-disabled {
  --tw-text-opacity: 1;
  color: rgb(233 231 233 / var(--tw-text-opacity));
}
.text-table-pagination-text-pg {
  --tw-text-opacity: 1;
  color: rgb(69 66 80 / var(--tw-text-opacity));
}
.text-table-pagination-text-pgSelected {
  --tw-text-opacity: 1;
  color: rgb(26 22 40 / var(--tw-text-opacity));
}
...
.text-tags-text-processing {
  --tw-text-opacity: 1;
  color: rgb(64 140 255 / var(--tw-text-opacity));
}
.text-tags-text-success {
  --tw-text-opacity: 1;
  color: rgb(127 208 125 / var(--tw-text-opacity));
}
.text-tags-text-warning {
  --tw-text-opacity: 1;
  color: rgb(234 201 89 / var(--tw-text-opacity));
}
.text-white {
  --tw-text-opacity: 1;
  color: rgb(255 255 255 / var(--tw-text-opacity));
...
.hover\\:border-table-pagination-border-hover:hover {
  --tw-border-opacity: 1;
  border-color: rgb(98 210 209 / var(--tw-border-opacity));
}
...
.hover\\:bg-table-pagination-bg-hover:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(98 210 209 / var(--tw-bg-opacity));
}
...
.hover\\:text-table-pagination-text-hover:hover {
  --tw-text-opacity: 1;
  color: rgb(255 255 255 / var(--tw-text-opacity));
}
